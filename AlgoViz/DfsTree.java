...
public class DfsTree extends DfsInterface<TreeNode> implements TreeAlgorithm{

    private final String ALGO = "Tree DFS";
    ...
    @Override
    public void print() {
        Helper.printTreeMap(getSource(),depth);
    }
    ...
    public void initialiseMap() {
        System.out.println("Please enter the map size (keep till 7 for better visuals)");
